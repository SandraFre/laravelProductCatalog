        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    ...
                    supplier</div>
                <form
                    action="{{ route('supplier.' . (isset($item->id) ? 'update' : 'store'), isset($item->id) ? ['supplier' => $item->id] : []) }}"
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control @error('phone') is-invalid @enderror" type="text" name="phone"
                                id="phone" value="{{ old('phone', $item->phone ?? '') }}">
                            @error('phone')
                            <div class="alert-danger">
                                {{ $message }}
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            @isset($item->logo)
                                <img src="{{Storage::url($item->logo)}}" width="100px" class="border">
